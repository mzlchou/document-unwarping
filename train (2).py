...
try:
    ...
    print("✓ Perceptual loss created (helps preserve text!)")
...
print(f"✓ Loss: L1 (0.2) + SSIM (0.5) + Perceptual (0.3)" if SSIM_AVAILABLE else "✓ Loss: L1 only")
...
for epoch in range(1, CONFIG['num_epochs'] + 1):
    ...
    if is_best:
        ...
        print(f"  ✨ NEW BEST! (SSIM: {avg_val_ssim:.4f})")  # NEW
...
#             mask = mask.expand_as(l1_loss)  # [B, 1, H, W] → [B, 3, H, W]
